    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-background">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 px-6 py-6 flex items-center justify-between max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-3">
          <img src={logoSymbol} alt="" className="h-8 w-8" />
          <span className="text-lg font-bold text-foreground tracking-tight">GridForge</span>
        </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-32 pb-20 w-full">
        <div className="flex flex-col items-center text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-card mb-10"
          >
          ...
          >
            <img src={logoSymbol} alt="" className="h-14 w-14 md:h-16 md:w-16" />
            <span className="text-4xl md:text-5xl lg:text-6xl font-display font-bold tracking-tight text-foreground">
              GridForge
            </span>
          </motion.div>
